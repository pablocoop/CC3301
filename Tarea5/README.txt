...
En la clase auxiliar del viernes 4 de octubre se estudió la solución
de una tarea similar de un semestre pasado.

Programe la versión en C de la función sort en el archivo sort-c-hexamax.c y
pruebe con:
...
De otra forma su tarea será rechazada.  Para depurar ejecute el comando:
  ...
  make sort-c-hexamax.ddd

Cuando funcione correctamente, programe la versión en assembler Risc-V en
el archivo sort-rv-hexamax.c.  Pruebe con el comando:

  make sort-rv-hexamax.c
